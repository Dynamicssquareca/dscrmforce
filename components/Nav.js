    ...
    <>
      <nav id="navbar" className="navbar">
        <ul>
          ...
          <li><a className="getstarted-outline" href="tel:+12134389925"><div className='call-btn'><svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
          ...
          </svg><div className='call-r'>Give us a call <span>+1 213 438 9925</span></div></div></a></li>
